...
#onze inpur_directory bevat nu het path naar alle bamfiles die in de map bam staan. We moeten hierin nog een selectie maken van de bamfiles die voor de analyse gebruikt moeten worden --> maken een lijst met deze benodigde bamfiles. 

input_bam_files <- list.files(path= input_directory, pattern= ".*\.bam$", full.names= TRUE)
...
# we gebruiken de al gegenereerde count table
