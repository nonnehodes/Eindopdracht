...
sample_data_frame <- sample_data_frame %>% mutate(behandeling= str_replace(Cell_type, "", "BCLXL"), str_replace(Cell_type, "", "ONECUT3"))



mutate(behandeling= str_replace(c(Cell_type, "" = "BCLXL"), c(Cell_type, "" = "ONECUT3"))
mutate(behandeling= str_replace(Cell_type, c("" = "BCLXL"), c("" = "ONECUT3"))
