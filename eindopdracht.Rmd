...
summary_PCA_2 %>% ggplot(aes(x = PC, y = Percentage_variance )) +
  ...
  ggtitle("PC") +
  xlab("PC") +
  ylab("Percentage van de variatie")
...
```{r Resultaten GO-term enrichment}
...
GOterm_analyse_up20 <- GOterm_analyse_up_selected[order(GOterm_analyse_up_selected$P

GOterm_analyse_down20 <- goterm_down_selected[order(goterm_down_selected$Pvalue)[1:20],]
...
xlab("GO-terms)+
ggtitle("De 20 meest verrijkte GO-terms van de upgereguleerde genen")
...
ylab(expression(-log[10](adjusted~italic(P)~value)))+
xlab("GO-terms)+
ggtitle("De 20 meest verrijkte GO-terms van de downgereguleerde genen")
```
