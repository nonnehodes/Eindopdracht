...
repace_string <- c("Skin derived fibroblast overexpressing Bclxl" = "BCLXL", "2 days after induction of OC3 in skin derived fibroblasts" = "ONECUT3")
sample_data_frame_2 <- sample_data_frame %>% mutate(behandeling= str_replace_all(Cell_type,repace_string))
